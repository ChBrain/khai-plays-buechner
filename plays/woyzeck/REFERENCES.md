...
- **[play_woyzeck.md](play_woyzeck.md)**: The root production. Defines the closed cast and the strictly descending arc.
- **the seats ([garrison captain](position_garrison_captain.md), [regimental doctor](position_regimental_doctor.md), [drum major](position_drum_major.md))**: The institutional vectors of extraction. They hold power regardless of the persona filling them.
- **the subaltern ([the subaltern soldier](position_subaltern_soldier.md))**: The bottom seat that absorbs the weight of the structure.
- **the exhaust ([the shaving](process_the_shaving.md), [the pea diet](process_the_pea_diet.md))**: The literal processes of extraction, exchanging groschen for physical and mental deterioration.
- **the final cost ([the pond](place_the_pond.md), [the knife](piece_the_knife.md), [the killing](process_the_killing.md))**: The inevitable resolution of the vectors when all other resources have been spent.